...
declare global {
  export type SvgName = 'check' | 'chevron-down' | 'chevron-left' | 'chevron-right' | 'chevron-up' | 'chevrons-left' | 'chevrons-right' | 'close' | 'filter' | 'loading' | 'map' | 'menu' | 'minus' | 'moon' | 'more-vertical' | 'plus' | 'search' | 'settings' | 'sun' | 'view-document' | 'view-grid' | 'view-list' | 'default'
  interface Window {
    ust: {
