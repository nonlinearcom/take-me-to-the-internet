...
declare global {
  export type SvgName = 'check' | 'chevron-down' | 'chevron-left' | 'chevron-right' | 'chevron-up' | 'close' | 'filter' | 'loading' | 'minus' | 'moon' | 'more-vertical' | 'plus' | 'search' | 'settings' | 'sun' | 'default'
  interface Window {
    ust: {
